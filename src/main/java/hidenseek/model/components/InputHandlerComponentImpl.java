...
public class InputHandlerComponentImpl extends AbstractComponent implements InputHandlerComponent {
    ...
    public InputHandlerComponentImpl() {
        ...
        this.oneTimeActions = new LinkedHashMap<KeyCode, Consumer<Entity>>();
        this.disabledKeys = new HashSet<KeyCode>();
    }
    ...
    @Override
    public void mapKeyToOneTimeAction(KeyCode key, Consumer<Entity> action) {
